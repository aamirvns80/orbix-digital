...
const SERVICES = [
    ...
    },
    {
        ...
        description: "Supercharge your business with intelligent AI agents — calling, reception, WhatsApp bots, and website chatbots that work 24/7.",
        features: [
            "AI Calling & sales agents",
