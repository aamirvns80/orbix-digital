...
const CASE_STUDIES = [
    {
        ...
        content: [
            ...
            { type: "paragraph", text: "TechVista Solutions, a growing SaaS company in Mumbai, was struggling to gain organic visibility in a crowded market. Their content strategy was unfocused, and technical SEO issues were holding back their rankings despite having a strong product." },
            ...
            { type: "list", items: ["Complete technical SEO overhaul including site speed optimization", "Topical cluster strategy with 12 pillar content pieces", "Strategic link building targeting high-authority Indian publications", "Weekly content calendar aligned with buyer journey stages", "Custom analytics dashboard for real-time performance tracking"] },
            { type: "heading", text: "The Results" },
            { type: "paragraph", text: "Within 6 months, TechVista saw their organic traffic triple. More importantly, the quality of that traffic improved dramatically — qualified leads increased by 150%, and their sales team reported much warmer inbound conversations." },
            { type: "paragraph", text: "The foundation we built continues to compound. TechVista now ranks in the top 3 for their most valuable commercial keywords, driving a sustainable pipeline of high-intent prospects." },
        ],
    },
    {
        ...
        tags: ["Paid Advertising (PPC)", "Social Media Management", "Email Marketing"],
        ...
        stats: [
            ...
            { label: "Revenue", value: "₹70L", description: "attributed to campaign" },
        ],
        content: [
            { type: "heading", text: "The Challenge" },
            { type: "paragraph", text: "BrandShakti Digital, a D2C e-commerce brand in Bangalore, was generating only 50 leads per month through outdated marketing tactics. They needed a modern, multi-channel approach to fuel their ambitious growth targets." },
            { type: "heading", text: "Our Approach" },
            ...
            { type: "heading", text: "The Results" },
            { type: "paragraph", text: "Within 4 months, BrandShakti went from 50 to over 500 qualified leads per month while reducing their cost per lead by 62%. The automated systems we built continue to scale effortlessly." },
        ],
    },
    {
        ...
        content: [
            { type: "heading", text: "The Challenge" },
            { type: "paragraph", text: "PixelCraft India had outgrown their original brand identity. Their visual language didn't reflect the caliber of work they produced, and they were losing pitch opportunities to better-branded competitors in Ahmedabad and beyond." },
            { type: "heading", text: "Our Approach" },
    ...
    },
    {
        ...
        tags: ["AI Automation Services", "WhatsApp Marketing"],
        gradient: "from-emerald-500 to-teal-400",
        image: "/images/case-studies/finedge.png",
        stats: [
            { label: "Pipeline Value", value: "₹2Cr", description: "in first quarter" },
        ...
        content: [
            { type: "heading", text: "The Challenge" },
            { type: "paragraph", text: "FinEdge Capital, a financial services firm in Delhi, had a manual, inefficient sales process. Their team was spending 40+ hours per week on data entry, lead qualification, and follow-ups — time that could be spent closing deals." },
            { type: "heading", text: "Our Approach" },
            { type: "paragraph", text: "We built an end-to-end pipeline automation system using MarketifyDigiAI, integrating their CRM, WhatsApp Business API, email marketing, and analytics platforms into a unified, intelligent workflow." },
            { type: "list", items: ["Automated lead scoring based on 15+ behavioral signals", "AI-powered WhatsApp chatbot for instant lead qualification", "Intelligent routing to the right rep within minutes", "Multi-touch nurture sequences for each segment", "Real-time pipeline dashboards and forecasting"] },
            { type: "heading", text: "The Results" },
            { type: "paragraph", text: "The automation platform generated ₹2Cr in qualified pipeline in its first quarter. The sales team reclaimed 40 hours per week, and their lead response time dropped from hours to under 5 minutes." },
        ],
    },
    {
        ...
        tags: ["Video Production", "Social Media Management", "Influencer Marketing"],
        ...
        content: [
            { type: "heading", text: "The Challenge" },
            { type: "paragraph", text: "Sunrise Wellness, a healthcare brand in Pune, needed to establish thought leadership in the digital health space but was struggling to stand out on social media with traditional text and image content." },
            { type: "heading", text: "Our Approach" },
            { type: "paragraph", text: "We developed a video-first content strategy that humanized their brand through expert interviews, patient stories, and educational health content optimized for each platform. We also partnered with health & wellness influencers for broader reach." },
            { type: "list", items: ["Platform-specific video content (Instagram Reels, YouTube Shorts)", "Expert interview series with healthcare professionals", "Educational animation series on health topics", "Influencer collaborations with wellness micro-influencers", "Paid amplification of top-performing organic content"] },
            { type: "heading", text: "The Results" },
            { type: "paragraph", text: "The video strategy drove 4x engagement rates, 2.1M total views, and established Sunrise Wellness as a leading voice in digital health content. Their social channels became a genuine patient acquisition funnel." },
        ],
    },
    {
        ...
        tags: ["Paid Advertising (PPC)", "Email Marketing", "Web Design & Development"],
        gradient: "from-sky-500 to-blue-400",
        image: "/images/case-studies/ecomking.png",
        stats: [
            { label: "Revenue", value: "₹75L", description: "in 90 days" },
        ...
        content: [
            { type: "heading", text: "The Challenge" },
            { type: "paragraph", text: "E-Com King, an e-commerce brand in Jaipur, had a strong product catalog but was leaving money on the table with unoptimized ad spend, low email revenue, and landing pages that weren't converting." },
            { type: "heading", text: "Our Approach" },
            ...
            { type: "heading", text: "The Results" },
            { type: "paragraph", text: "E-Com King hit ₹75L in attributed revenue within 90 days. Their ROAS improved to 8.2x, average order value jumped 35%, and the automated email flows now generate 28% of total revenue on autopilot." },
        ],
    },
];
